...
/// this is a private variable only this class can access, modify or delete it
/// this is what we call encapsulation
/// it is safe & much better
    int _questionNumber = 0; // to keep track the index of the question
    ...
    void nextQuestion(){ // go to the next question
      if( _questionNumber < _questionBank.length-1 ){ // if there is more questions left
        _questionNumber++;
      } 
